...
public class AgendaAdapter extends RecyclerView.Adapter<AgendaAdapter.AgendaViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AgendaViewHolder holder, int position) {
        ...
        holder.getData().setText(agen.getData());
        holder.getHora().setText(agen.getHora());
        holder.getProfessor().setText(agen.getProfessor());
        holder.getCurso().setText(agen.getCurso());
        holder.getResumo().setText(agen.getResumo());
        holder.getUf().setText(agen.getUf());
        holder.getCidade().setText(agen.getCidade());
        holder.getCep().setText(agen.getCep());
